...
export const metadata = { title: 'ZooLark Web Instrument — RP2350 USB Lab', description: '示波器、频谱、VNA、信号/PWM、直流电源、电池、逻辑分析、KXTJ3姿态传感器、JTAG/FPGA 的 WebUSB 上位机' };
export default function RootLayout({ children }) {
  return <html lang="zh-CN"><head><link rel="stylesheet" href="/styles.css" /></head><body>{children}
    ...
    <Script src="/device/kxtj3-bridge.js" strategy="afterInteractive" />
